...
require_relative "lib/core/test/version"

Gem::Specification.new do |spec|
  spec.name = "core-test"
  spec.version = Core::Test::VERSION
  spec.authors = ["Max Schridde"]
  spec.email = ["maxjschridde@gmail.com"]

  spec.summary = "CORE extension for application testing"
  spec.description = "CORE::Test is a testing extension for the CORE Platform."
  ...
  spec.metadata["changelog_uri"] = "https://github.com/talysto/groovestack-core/core-test"
