...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'CORE extension for referrals backend'
  spec.description = 'CORE::Referrals is a referrals extension for the CORE Platform.'
  spec.post_install_message = 'CORE::Referrals installed'
  ...
  spec.metadata['changelog_uri'] = 'https://moonlight-labs.com/core/core-referrals#changelog'
  ...
  spec.add_dependency 'counter_culture'
