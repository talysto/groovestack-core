    ...
    module GraphQL
      module Filters
        class CommentFilter < Types::BaseInputObject
          ...
          argument :created_at_lte, String, required: false, description: ::CoreBase::GraphQL::Documentation::Arguments.created_at_lte
          argument :ids, [ID], required: false, description: ::CoreBase::GraphQL::Documentation::Arguments.ids
          argument :q, String, required: false, description: ::CoreBase::GraphQL::Documentation::Arguments.q
