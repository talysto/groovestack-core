        ...
        module Job
          ...
          included do
            field :Job, ::Core::Job::GraphQL::Types::Job, null: true, resolver_method: :job do
              argument :id, ::Core::Job::GraphQL::Types::Base::Object::ID, required: true
            end

            field_with_filter_pagination_sort :allJobs, type: [::Core::Job::GraphQL::Types::Job], filter_type: ::Core::Job::GraphQL::Types::Filter::JobFilter, null: false, resolver_method: :jobs

            # use Admin::Types::ListMetadata b/c jobs are only used acessed by admin
            field_with_filter_pagination_sort :_allJobsMeta, type: ::Admin::Types::ListMetadata, filter_type: ::Core::Job::GraphQL::Types::Filter::JobFilter, camelize: false, null: true, resolver_method: :jobs_meta
          end
