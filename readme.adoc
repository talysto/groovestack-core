...
* add `has_core_versions` to any wanted models (this supports options passed in for what to monitor the same as [PaperTrail](https://github.com/paper-trail-gem/paper_trail#2c-choosing-attributes-to-monitor))
