...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'CORE extension for full-stack background version management'
  spec.description = 'CORE::Versions is a high-performance versioning tracker extension for the CORE Platform.'
